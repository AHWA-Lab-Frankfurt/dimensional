...
```{r}
cor.matlist.w <- dimension_matlist(decor.graph, name, weighted = TRUE) 

cor.matlist <- dimension_matlist(decor.graph, name) 
cor.matlist[[1]]
...
dimension.pv <- dimension_correlation(cor.matlist.w, pvalue = TRUE)[[2]]
#plotting a heatmap for the correlation matrix
