...
```{r}
dimension.correlation.node <- dimension_correlation_node(decor.graph) 
...
dimension.pvalue.node <- dimension_correlation_node(decor.graph, pvalue = TRUE)[[2]] 
...
dimension.correlation.node <- dimension_correlation_node(decor.graph, weight = TRUE) 
...
dimension.pvalue.node <- dimension_correlation_node(decor.graph, weight = TRUE, pvalue = TRUE)[[2]] 
